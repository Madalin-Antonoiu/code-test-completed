...
<style lang="scss">
  ...
  .card-grid {
    ...
    @media screen and (max-width: 600px) {                    // <600px
      .card-grid {grid-template-columns: repeat(1, minmax(320px, 1fr));}
    }
    ...
    @media (min-width: 801px) and (max-width: 1024px) {       // <801-1024px>
      .card-grid {grid-template-columns: repeat(3, minmax(200px, 1fr));}
    }
    @media screen and (min-width: 1025px) {                   // >1025px
      .card-grid {grid-template-columns: repeat(4, minmax(200px, 1fr));}
    }
